...
IMPLICIT NONE
  ...
  double precision, allocatable :: bpot(:)
  double precision, allocatable :: cpot(:)
  double precision, allocatable :: bpsi(:)
  double precision, allocatable :: cpsi(:)
  double precision, allocatable :: pot(:)
  double precision, allocatable :: pot0(:)
  double precision, allocatable :: pot1(:)
  double precision, allocatable :: spec(:, :)
  double precision, allocatable :: beta(:, :)
  double precision, allocatable :: potcha(:)
...
CONTAINS
  ...
  SUBROUTINE set_density_and_qns(params, params_size, qns, qns_size)
    integer,                                  intent(in) :: params_size
    double precision, dimension(params_size), intent(in) :: params
    integer,                                  intent(in) :: qns_size
