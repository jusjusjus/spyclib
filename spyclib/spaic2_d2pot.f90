...
IMPLICIT NONE
  ...
  ! ALLOCATABLES
  double precision, allocatable :: parapot(:), pararho(:)
  double precision, allocatable :: bsplinepot(:, :), bsplinerho(:,:)
  double precision, allocatable :: rr(:)
  double precision, allocatable :: rbump(:), dbump(:)
...
CONTAINS
  ...
  FUNCTION potwosa(r,vclus,rclus,drclus)
    implicit none
    double precision, intent(in) :: r,vclus,rclus,drclus
